...
ActiveRecord::Schema.define(version: 20190414045312) do
  ...
  create_table "repeating_transactions", force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "repeating_transfers", force: :cascade do |t|
    t.integer "user_id"
