  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved transfer as @transfer" do
        ...
        post :create, {:transfer => { "user_id" => "invalid value" }}, valid_session
        assigns(:transfer).should be_a_new(Transfer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested transfer" do
        ...
        Transfer.any_instance.should_receive(:update).with({ "user_id" => "1" })
        put :update, {:id => transfer.to_param, :transfer => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the transfer as @transfer" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Transfer.any_instance.stub(:save).and_return(false)
        put :update, {:id => transfer.to_param, :transfer => { "user_id" => "invalid value" }}, valid_session
        assigns(:transfer).should eq(transfer)
      end
